...
const mealNutrients = {
    // Default nutrients...
    "Chicken rice porridge with ginger": { iron: 2, calcium: 1, folate: 1, fiber: 1 },
    "Oatmeal with banana and honey": { iron: 1, calcium: 1, folate: 1, fiber: 3 },
    "Toast with peanut butter + warm soy milk": { iron: 1, calcium: 2, folate: 2, fiber: 2 },
    "Fish congee with soft tofu": { iron: 1, calcium: 2, folate: 1, fiber: 1 },
    "Boiled egg + toast + orange juice": { iron: 2, calcium: 1, folate: 3, fiber: 2 },
    "Steamed rice + chicken + veggies": { iron: 2, calcium: 1, folate: 2, fiber: 2 },
    "Rice noodle soup with tofu and spinach": { iron: 3, calcium: 2, folate: 3, fiber: 2 },
    "Small pasta with tomato and ground turkey": { iron: 2, calcium: 1, folate: 2, fiber: 2 },
    "Rice + ginger fish + steamed broccoli": { iron: 2, calcium: 1, folate: 3, fiber: 3 },
    "Chicken porridge": { iron: 2, calcium: 1, folate: 1, fiber: 1 },
    "Crackers + warm tea": { iron: 0, calcium: 0, folate: 1, fiber: 1 },
    "Banana or apple": { iron: 0, calcium: 0, folate: 1, fiber: 2 },
    "Yogurt cup": { iron: 0, calcium: 3, folate: 0, fiber: 0 },
    "Nuts (almond, cashew – small handful)": { iron: 1, calcium: 1, folate: 1, fiber: 2 },
    "Smoothie (banana + oats + milk)": { iron: 1, calcium: 2, folate: 1, fiber: 3 },
    "Chicken soup + rice + steamed veggies": { iron: 2, calcium: 1, folate: 2, fiber: 2 },
    "Tofu soup with mushroom": { iron: 2, calcium: 2, folate: 2, fiber: 2 },
    "Noodle soup with egg": { iron: 2, calcium: 1, folate: 2, fiber: 1 },
    "Rice porridge with fish": { iron: 2, calcium: 1, folate: 1, fiber: 1 },
    "Clear veggie soup + rice + boiled egg": { iron: 2, calcium: 1, folate: 2, fiber: 2 }
};
...
// --- MODAL AND MEAL MANAGEMENT LOGIC ( Largely unchanged )---
...
function populateMealList() {
    ...
    meals.forEach(meal => {
        ...
        const nutrients = allNutrients[meal] || { iron: '?', calcium: '?', folate: '?', fiber: '?' };
