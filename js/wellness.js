...
async function handleAddSupplement() {
    ...
    const userQuery = `Evaluate this supplement for pregnancy: "${userSupp}"`; const apiKey = "AIzaSyDyi7Dn0s3E1VESi4O0ElWEXoCW4ENWOVc"; const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-09-2025:generateContent?key=${apiKey}`;
    const payload = {
