...
function handleTabSwitch(activeTab) {
    ...
    // NEW: Stop all calm space activities when switching away
    if (activeTab !== 'calm') {
        // This function will be defined in calm-space.js and will stop sounds, timers, etc.
        unloadCalmSpace(); 
    }
}
